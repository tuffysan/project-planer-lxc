...
# v2.1.1 no longer uses GitHub Actions. A workflow file from v2.1.1 would
...
if ($Version -notmatch '^\d+\.\d+\.\d+$') {
    Fail "Version must use semantic format, for example 2.1.1"
}
...
# If v2.1.1 previously staged/committed dist locally, untrack it now.

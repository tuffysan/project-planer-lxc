...
# v2.1.0 no longer uses GitHub Actions. A workflow file from v2.1.0 would
...
if ($Version -notmatch '^\d+\.\d+\.\d+$') {
    Fail "Version must use semantic format, for example 2.1.0"
}
...
# If v2.1.0 previously staged/committed dist locally, untrack it now.
